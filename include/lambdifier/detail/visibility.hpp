#ifndef LAMBDIFIER_DETAIL_VISIBILITY_HPP
#define LAMBDIFIER_DETAIL_VISIBILITY_HPP
...
#if defined(lambdifier_EXPORTS)

#define LAMBDIFIER_DLL_PUBLIC __declspec(dllexport)

#else

#define LAMBDIFIER_DLL_PUBLIC __declspec(dllimport)

#endif

#define LAMBDIFIER_DLL_LOCAL

#elif defined(__clang__) || defined(__GNUC__) || defined(__INTEL_COMPILER)

#define LAMBDIFIER_DLL_PUBLIC __attribute__((visibility("default")))
#define LAMBDIFIER_DLL_LOCAL __attribute__((visibility("hidden")))

#else

#define LAMBDIFIER_DLL_PUBLIC
#define LAMBDIFIER_DLL_LOCAL
...
#define LAMBDIFIER_DLL_PUBLIC_INLINE_CLASS

#else

#define LAMBDIFIER_DLL_PUBLIC_INLINE_CLASS LAMBDIFIER_DLL_PUBLIC
